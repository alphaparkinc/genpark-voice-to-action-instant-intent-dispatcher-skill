# genpark-voice-to-action-instant-intent-dispatcher-skill
...
> **GenPark AI Agent Skill** -- Voice-to-action semantic intent parser & webhook dispatcher (Wispr Action style)
